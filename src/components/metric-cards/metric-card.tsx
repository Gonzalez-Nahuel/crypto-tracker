...
export const MetricCard = ({ value }: MetricCardProps) => {
  return (
    <a className="flex flex-col justify-between bg-card p-2 xl:text-start md:text-center sm:text-start md:max-w-52 w-1/4  xl:max-w-72 shadow-sm shadow-[#0002] xl:rounded-2xl rounded-lg xl:flex xl:flex-col xl:justify-between xl:p-4">
