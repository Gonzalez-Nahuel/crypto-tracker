...
export const GridDetails = ({ data }: GridDetailsProps) => {
  return (
    <div className="grid grid-cols-2 grid-rows-4 gap-2.5">
      <div className="border border-thin col-span-2 p-2 flex flex-col items-center rounded-lg justify-center">
        <span className="text-xs text-gray-400">Market cap</span>
        <span className="text sm font-bold">
          {formatNumberAbbreviated(data.market_cap)}
        </span>
      </div>
      <div className="border border-thin flex flex-col items-center p-2 rounded-lg justify-center">
